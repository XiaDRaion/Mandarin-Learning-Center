...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-[70vh] flex items-center bg-gradient-to-br from-[#FFFDF9] via-[#FFFDF9] to-[#FFF5F5] py-8 px-4 font-sans overflow-hidden"
    >
      {/* Container */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 mb-10 lg:grid-cols-2 gap-12 lg:gap-8 items-center w-full relative z-10">
        ...
        <div className="relative w-full max-w-lg mx-auto lg:ml-auto mt-10 lg:mt-0">
          ...
          <div className="relative w-full aspect-[1/1] bg-gradient-to-br from-[#FFF4E5] to-[#FCF9F2] rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-white/50 transition-transform duration-500 hover:scale-105 cursor-pointer z-10">
          ...
          <div className="absolute -bottom-8 -left-8 bg-white rounded-3xl shadow-xl border border-gray-100 border-t-4 border-t-[#DA291C] z-20">
            <div className="flex items-center gap-4 p-5">
              ...
              <div>
                <p className="text-[#0C1B33] font-bold leading-tight">
                  HSK Certified
                </p>
